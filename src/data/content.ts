...
export const PROJECTS: Project[] = [
  {
    ...
    fullDescription:
      "Полноценное веб-приложение для хранения и поиска рецептов. Регистрация и авторизация, добавление своих рецептов с фото и пошаговым описанием, фильтрация по категориям и ингредиентам. Реализована работа с MongoDB для хранения данных, Express для серверной логики и React для интерфейса. ( Сервера могут работать нестабильно нужно просто подождать. Если долго не загружаются данные включите VPN)",
