...
export const PROJECTS: Project[] = [
  {
    ...
    fullDescription:
      "Полноценное веб-приложение для хранения и поиска рецептов. Регистрация и авторизация, добавление своих рецептов с фото и пошаговым описанием, фильтрация по категориям и ингредиентам. Реализована работа с MongoDB для хранения данных, Express для серверной логики и React для интерфейса. ( Сервера могут работать не стабильно нужно просто подождать. Если долго не загружаются данные включите VPN)",
  ...
  },
  {
    ...
    fullDescription:
      "Панель управления для сайта: управление пользователями, контентом и статистикой. Защищённый доступ, динамические таблицы, фильтрация и пагинация данных. Создана на TypeScript, Express и React с акцентом на типизацию и безопасность. (Тестовый аккаунт с админкой: test@test.com | testtest )   Сервера могут работать не стабильно нужно просто подождать. Если долго не загружаются данные включите VPN",
